...
import { Check, Circle, Loader2, Camera, AlertCircle, Clock, ChevronRight, X, MessageSquare, Edit } from 'lucide-react'
...
export function ActiveJobCard({ request, player }: ActiveJobCardProps) {
  ...
  return (
    <div className={`bg-gradient-to-br ${bgColor} rounded-xl shadow-lg border-2 ${borderColor} overflow-hidden`}>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mb-4">
                ...
                Once they authorize payment, the job will begin.
              </p>
      ...
      {!isReadyForPickup && !isQuotePending && currentTask && (
      ...
      {/* All Tasks Checklist - Only show when not in quote pending state */}
      {!isQuotePending && (
      ...
      {/* Mark Ready Section - Only show when not in quote pending state and all tasks are complete */}
      {!isReadyForPickup && !isQuotePending && allRequiredComplete && (
